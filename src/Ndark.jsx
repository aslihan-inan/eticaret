export default function Topbar() {
  return (
    <div className="bg-gray-900 text-gray-200 text-sm px-4 py-2 flex flex-col md:flex-row justify-between items-center gap-3">
      ...
      {/* Telefon ve Email */}
      <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-6 text-center md:text-left">
        <div className="flex items-center gap-1">
          <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 5h18M3 12h18M3 19h18" />
          </svg>
          <span className="font-semibold whitespace-nowrap">(225) 555-0118</span>
        </div>
        <div className="flex items-center gap-1">
          <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M16 12l-4-4-4 4m8 0v6a2 2 0 01-2 2H8a2 2 0 01-2-2v-6" />
          </svg>
          <span className="font-semibold whitespace-nowrap truncate max-w-[200px] sm:max-w-xs md:max-w-sm">
      ...
      {/* Ortadaki yazı */}
      <div className="text-center md:text-left text-gray-300 font-semibold text-sm md:text-base">
        Follow Us and get a chance to win 80% off
      </div>

      {/* Sosyal Medya */}
      <div className="flex flex-wrap justify-center md:justify-end items-center gap-3 text-gray-300 font-semibold text-sm md:text-base">
